...
#ifndef OMDefaultInBound_H
#define OMDefaultInBound_H
...
class RP_FRAMEWORK_DLL OMDefaultInBound : public IOxfReactive {
...
public :
    ...
    OMDefaultInBound(void);
    
    //## auto_generated
    virtual ~OMDefaultInBound(void);
...
public :
    ...
    //## auto_generated
    void setItsDefaultProvidedInterface(IOxfReactive* p_IOxfReactive);
...
private :
    ...
    IOxfReactive* itsDefaultProvidedInterface;		//## link itsDefaultProvidedInterface

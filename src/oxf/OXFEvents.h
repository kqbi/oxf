...
class OMStartBehaviorEvent : public OMEvent {
...
class OMEndThreadEvent : public OMEvent {
...
class OMReactiveTerminationEvent : public OMEvent {
    ////    Constructors and destructors    ////
...
public :
    ...
    unsigned long t;		//## auto_generated

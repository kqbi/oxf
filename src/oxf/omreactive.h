...
protected :
    ...
    virtual void handleNotConsumed(IOxfEvent::Ptr & /*ev*/, IOxfReactive::EventNotConsumedReason /*reason*/);
    ...
    virtual std::shared_ptr<IOxfTimeout> scheduleTimeout(unsigned long delay, const char *targetStateName = NULL);
...
private :
    ...
    static const uint32_t nullTransitionStateMask;        //## attribute nullTransitionStateMask
    ...
    static const uint32_t terminateConnectorReachedStateMask;        //## attribute terminateConnectorReachedStateMask

    // OMReactive state mask - the instance is under destruction
    static const uint32_t underDestructionStateMask;        //## attribute underDestructionStateMask

    // OMReactive state mask - the reactive instance should be deleted when a terminate connector is reached
    static const uint32_t deleteOnTerminateStateMask;        //## attribute deleteOnTerminateStateMask

    // OMReactive state mask - need to complete the startBehavior() by a start behavior event
    static const uint32_t shouldCompleteStartBehaviorStateMask;        //## attribute shouldCompleteStartBehaviorStateMask

    // OMReactive state mask - startBehavior() was called
    static const uint32_t behaviorStartedStateMask;        //## attribute behaviorStartedStateMask
    ...
    std::shared_ptr<OMStartBehaviorEvent> theStartOrTerminationEvent;        //## attribute theStartOrTerminationEvent
    ...
    static const uint32_t destroyEventResentStateMask;        //## attribute destroyEventResentStateMask

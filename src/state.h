...
class OMOrState : public OMState {
    ////    Constructors and destructors    ////
...
class OMComponentState : public OMOrState {
    ////    Constructors and destructors    ////
...
class OMLeafState : public OMState {
    ////    Constructors and destructors    ////
...
//## class OMAndState
// A concurrent state
class OMAndState : public OMLeafState {
    ////    Constructors and destructors    ////
...
//## class OMFinalState
// UML Final state
class OMFinalState : public OMLeafState {
    ////    Constructors and destructors    ////
...
public :
    ...
    inline OMFinalState(IOxfReactive *cpt, OMState *par, OMState *cmp, const char *hdl = NULL) : OMLeafState(par, cmp),

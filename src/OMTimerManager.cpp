...
void OMTimerManager::consumeTime(unsigned long interval, unsigned long /*step*/,
                                 IOxfActive *const theContext) {
...
void OMTimerManager::consumeTime(unsigned long interval,
                                 IOxfActive *const theContext) {
...
bool OMTimerManager::set(IOxfTimeout::Ptr &timeout) {
  ...
  bool res =
      true;  // it is true if no need to cleanup or timeouts deleted from heap
...
void OMTimerManager::goNext(void) {
  ...
  //         IOxfTimeout* timeout =
  //         reinterpret_cast<IOxfTimeout*>(timeouts.top()); if
  //         (timeout->isCanceled()) {
  //             // destroy the canceled timeout
  //             timeout->destroy();
  //             timeouts.trim(); // trim the timeout
...
void OMTimerManager::post(void) {
  ...
  //         IOxfTimeout* timeout =
  //         reinterpret_cast<IOxfTimeout*>(timeouts.top()); if (time_ <
  //         timeout->getDueTime()) {
  //             // no ready timeouts
  //             break;
  //         }
...
unsigned long OMTimerManager::getTick(void) const { return tick; }

bool OMTimerManager::getRealTimeModel(void) const { return realTimeModel; }

bool OMTimerManager::getSuspended(void) const { return suspended; }

bool OMTimerManager::getAllowDestroy(void) { return allowDestroy; }

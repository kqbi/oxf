...
//## class OMEvent
OMEvent::OMEvent(IOxfEvent::ID eventId, std::shared_ptr<IOxfReactive> dest) : lId(eventId), deleteAfterConsume(true),
...
unsigned long OMEvent::getDelayTime(void) const {
    //#[ operation getDelayTime() const
    return 0;
    //#]
}

unsigned long OMEvent::getDueTime(void) const {
...
void OMEvent::setDelayTime(unsigned long /**/) {
    //#[ operation setDelayTime(unsigned long)
    //#]
}

void OMEvent::setDueTime(unsigned long /**/) {
...
std::weak_ptr<IOxfReactive>& OMEvent::getDestination(void) {
    return destination;
}
